class ProductsController < ApplicationController
  ...
  def index
    if is_prof
      ...
      @products=Product.find_all_by_student_id(Student.find(session[:user_id]).id)
      @search = params[:search]
      respond_to do |format|
        format.html # index.html.erb
        format.json { render json: @products }
    ...
    def create
      ...
      puts Product.find_all_by_student_id(Student.find(session[:user_id]).id)
      puts "-------------------------------"


      @product = Product.new
      @product.name = params[:name]
      @product.student_id = Student.find(session[:user_id]).id
